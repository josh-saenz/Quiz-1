...
infile = csv.reader(vendor_list, delimiter = ',')
...
for i in infile: 
    ...
    Vendor["Name"] = {"Email": i[4], "Phone": i[5]}
...
outfile.write('Name, Email, Phone Number\n')

for i in Vendor['Name']:
  outfile.write(str(i['Name'])+','+i['Email']+','+str(i['Phone Numer'])'\n')
